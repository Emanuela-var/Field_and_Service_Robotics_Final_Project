#ifndef __STANLEY_sfun_h__
#define __STANLEY_sfun_h__
...
extern mxArray* load_STANLEY_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_STANLEY_optimization_info(void);
