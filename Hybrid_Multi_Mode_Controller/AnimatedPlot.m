% animate_vehicle_tracking.m - Vehicle tracking animation
% Shows only the bicycle animation without additional plots
% Requires Simulink simulation to be run with out_actual_state available
...
if save_video
    video_filename = sprintf('BICYCLE_PARKING_ANIMATION_HYBRID_CONTROLLER_%s.mp4');
